    ...
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          <p>
            Nexport Logistics offers freight forwarding services at its best, providing seamless and efficient transportation solutions for your goods across the globe. We act as an intermediary between shippers and various transportation services, handling all aspects of the logistics process.
          </p>
          <p>
