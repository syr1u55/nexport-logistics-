    ...
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          <p>
            Nexport Logistics supply chain professionals are committed to meeting and exceeding your expectations, providing end-to-end solutions that optimize every stage of your supply chain. We understand that an efficient supply chain is crucial for business success, and we are dedicated to delivering innovative and integrated management services.
          </p>
          <p>
